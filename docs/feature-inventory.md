...
> **削除済み（2026-08 整理）**: TTS / 効果音（PR #422）、zsh/powershell 固有ターミナル設定4つ・死んだ provider i18n placeholder（PR #421）、役割モード 4 件と `switch_mode` ツール・その自動承認トグル（PR #19・#21）。詳細は各節の **済** 参照。
...
| modes    | new_task（`switch_mode` は PR #19 で削除）                                            | —                                            |
