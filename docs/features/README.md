...
| `NFR-MNT-04` `NFR-MNT-04a`                             | 数えられる主張は正準の出所で数え、2 か所へ書くなら突き合わせる                                 |
...
| 対象                   | 件数 | 一次ソース                                                            |
| ---------------------- | ---- | --------------------------------------------------------------------- |
| 要件                   | 442  | `docs/requirements.md` の 3 章                                        |
| 機能要件               | 388  | 同上                                                                  |
| 非機能要件             | 54   | 同上                                                                  |
| 機能仕様               | 20   | `docs/features/`                                                      |
...
| コマンド               | 29   | `src/package.json` の `contributes.commands`                          |
