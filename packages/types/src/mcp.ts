...
export type McpToolCallResponse = {
	...
	content: Array<
		...
		| {
				// Added in MCP SDK 1.26.0: a link to a resource rather than the
				// resource bytes themselves. Consumers that don't recognise it
				// should treat it as an inert reference (uri + name + optional
