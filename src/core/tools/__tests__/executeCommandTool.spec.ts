...
describe("executeCommandTool", () => {
	...
	beforeEach(() => {
		...
		// Use shared factory; ExecuteCommandTool needs terminal-specific provider state + lastMessageTs preset.
		...
		mockCline.askState.lastMessageTs = Date.now()
		mockCline.tokenUsageTracker.recordToolUsage = vitest.fn().mockReturnValue({} as ToolUsage)
