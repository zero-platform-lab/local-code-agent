...
import type { WorktreeHandlerHost } from "./worktreeHandlerHost"
...
export async function handleListWorktrees(provider: WorktreeHandlerHost): Promise<WorktreeListResponse> {
...
export async function handleGetAvailableBranches(provider: WorktreeHandlerHost): Promise<BranchInfo> {
	const cwd = provider.cwd
...
export async function handleGetWorktreeDefaults(_provider: WorktreeHandlerHost): Promise<WorktreeDefaultsResponse> {
...
export async function handleGetWorktreeIncludeStatus(provider: WorktreeHandlerHost): Promise<WorktreeIncludeStatus> {
	const cwd = provider.cwd
...
export async function handleCheckoutBranch(provider: WorktreeHandlerHost, branch: string): Promise<WorktreeResult> {
	const cwd = provider.cwd
