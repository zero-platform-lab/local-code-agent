...
/**
 * Convert an array of LineRecords into merged ranges for output.
 *
 * 隣接しない行番号があれば別レンジに分割する。readWithIndentation からは常に連続した
 * 行だけが渡るため gap 分岐はその経路では踏まれないが、汎用ヘルパとして単体で検証できる
 * よう export している。
 */
