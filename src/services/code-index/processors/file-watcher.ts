...
import { QDRANT_CODE_BLOCK_NAMESPACE, MAX_FILE_SIZE_BYTES, BATCH_SEGMENT_THRESHOLD } from "../constants"
...
export class FileWatcher implements IFileWatcher {
	...
	private ignoreController: AgentIgnoreController
	...
	constructor(
		...
		ignoreController?: AgentIgnoreController,
		batchSegmentThreshold?: number,
	) {
		this.ignoreController = ignoreController || new AgentIgnoreController(workspacePath)
		if (ignoreInstance) {
		...
		try {
			...
			if (
				...
				return {
					path: filePath,
					status: "skipped" as const,
					reason: "File is ignored by .agentignore or .gitignore",
				}
			}
