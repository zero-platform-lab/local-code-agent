...
export const fallbackExtensions = [
	...
	// Scala。かつては languageParser.ts が Lua のクエリを流用していて壊れていたための回避策だったが、
	// その原因は解消済み（scalaQuery を使うよう修正）。tree-sitter による分割に切り替えられるが、
	// インデックスの挙動が変わるため現状は fallback のままにしてある。
	".scala",
