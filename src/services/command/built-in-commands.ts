...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .agent/rules-code/AGENTS.md (relative to project root)
       - .agent/rules-debug/AGENTS.md (relative to project root)
       - .agent/rules-ask/AGENTS.md (relative to project root)
       - .agent/rules-architect/AGENTS.md (relative to project root)
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .agent/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .agent folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .agent/rules-code/AGENTS.md (create .agent in project root, not system root!)
    - .agent/rules-debug/AGENTS.md (relative to project root)
    - .agent/rules-ask/AGENTS.md (relative to project root)
    - .agent/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .agent directory must be created in the current project/workspace root directory,
    ...
    ├── .agent/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .agent/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .agent/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .agent/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .agent/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
