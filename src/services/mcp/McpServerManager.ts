...
export class McpServerManager {
	...
	private static providers: Set<McpProviderRef> = new Set()
	 ...
	 */
	static async getInstance(context: vscode.ExtensionContext, provider: McpProviderRef): Promise<McpHub> {
	 ...
	 */
	static unregisterProvider(provider: McpProviderRef): void {
