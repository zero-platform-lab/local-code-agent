...
export const CORPUS: Case[] = [
	// 敬称と肩書き（第 1 層で取れる）
	{ text: "森さんから林の伐採について相談がありました。", pii: ["森"], clean: ["林"] },
	{ text: "山田部長に確認をお願いします。", pii: ["山田"], clean: ["部長"] },
	{ text: "田中本部長へ報告済みです。", pii: ["田中"], clean: ["本部長"] },
	{ text: "佐藤課長と鈴木主任が同席します。", pii: ["佐藤", "鈴木"] },
	{ text: "田中太郎さんへ連絡してください。", pii: ["田中太郎"] },
	{ text: "スミスさんが担当です。", pii: ["スミス"] },
	{ text: "営業部長に確認します。", pii: [], clean: ["営業部長"] },
	{ text: "部長さんに確認します。", pii: [], clean: ["部長"] },
	{ text: "お客様へのご案内です。", pii: [], clean: ["お客"] },
	{ text: "皆様おつかれさまでした。", pii: [], clean: ["皆"] },
	{ text: "本部長の承認が要ります。", pii: [], clean: ["本部長"] },
	...
	// 実データ（ストックマークの正解つき文例 2,000 文）で見つかった誤検出。
	// **私が書いた文例には 1 つも無かった形である。**
	{ text: "仕様を確認してください。", pii: [], clean: ["仕様"] },
	{ text: "要求仕様R.5 に則った設計です。", pii: [], clean: ["要求仕様"] },
	{ text: "多様な働き方を認めます。", pii: [], clean: ["多様"] },
	{ text: "同様の手順で進めます。", pii: [], clean: ["同様"] },
	{ text: "指導教授の紹介によります。", pii: [], clean: ["指導教授"] },
	{ text: "初代事務局長を務めました。", pii: [], clean: ["初代事務局長"] },
	{ text: "世界各国の王子様、王女様の話題です。", pii: [], clean: ["王子", "王女"] },
	{ text: "同社代表取締役社長に就任しました。", pii: [], clean: ["同社代表"] },
