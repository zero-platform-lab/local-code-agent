...
class ErrorBoundary extends Component<ErrorProps, ErrorState> {
	...
	async componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
		...
		this.setState((previous) => ({
			// Never clear what getDerivedStateFromError already derived. A thrown non-Error, or
			// an Error without a stack, has nothing to source map; blanking the state here would
			// render the children that just threw all over again.
			error: enhancedError.sourceMappedStack || enhancedError.stack || previous.error,
