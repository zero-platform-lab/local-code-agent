...
export const ModeSelector = ({
	...
	// Scroll the selected item into view when the popover opens. Focus is handled by Radix,
	// which moves it into the popover content (the search input) as it mounts.
	React.useEffect(() => {
		if (open) {
