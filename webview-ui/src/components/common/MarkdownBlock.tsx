...
/**
 * Renderers for the markdown elements the chat needs to treat specially. They never depend on
 * props or state, so they live at module scope and are shared by every block.
 */
